...
const Navbar = () => {
  return (
    <div className=" py-2 sm:py-3 md:py-3 lg:py-6 xl:py-6 2xl:py-6 flex border  justify-between items-center">
      ...
      <div className="  mr-3 sm:mr-3 md:mr-3 lg:mr-8 xl:mr-10 2xl:mr-10 gap-2 flex justify-start sm:justify-start sm:gap-2 md:gap-2 lg:gap-10 xl:gap-10 2xl:gap-10 md:justify-start  lg:justify-center items-center">
        ...
        <div className=" cursor-pointer relative sm:w-12 sm:h-12  md:w-10 md:h-10 lg:w-14 lg:h-14 xl:w-14 xl:h-14 2xl:w-14 2xl:h-14   flex justify-center items-center rounded-full  bg-gray-100 w-8 h-8">
